...
function hideMoreText(card) {
    ...
    card.wrap.desc.querySelector('.desc').remove();
...
function showMoreText(card) {
    ...
    const textLorem = 'произвольный lorem произвольный lorem произвольный lorem'
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class='desc>${textLorem}</div>'`);
